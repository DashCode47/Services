package com.homework.orderservice.service;
...
import com.homework.orderservice.repository.OrderRepository;
...
public class OrderService {
    ...
    public TransactionResponse saveOrder(TransactionRequest request){
        ...
        response=paymentResponse.getPaymentStatus().equals("success")?"payment procc. succes.":"failure in payment api";
